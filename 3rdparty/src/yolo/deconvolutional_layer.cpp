...
{
    int i;
    deconvolutional_layer l = { (LAYER_TYPE)0,(ACTIVATION)0,(COST_TYPE)0,0 };
    ...
    float scale = 1./sqrt((double)(size*size*c));
    ...
    l.update = (decltype(l.update))update_deconvolutional_layer;
