...
/* Don't include cstdlib for non-GNU C libraries because some of them
...
#ifdef  __GNU_LIBRARY__
/* We want to avoid inclusion of cstring with non-GNU libraries
